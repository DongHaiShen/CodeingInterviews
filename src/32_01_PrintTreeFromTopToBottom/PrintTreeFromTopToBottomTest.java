...
/**
 * @Author sdh
 * @Date Created in 2019/2/27 19:12
 * @description
 */
public class PrintTreeFromTopToBottomTest
{
    public static void main(String[] args)
    {
        ...
        System.out.println("\n");
        print(test.printFromTopToBottom(root2));
        ...
        System.out.println("\n");
        print(test.printFromTopToBottom(root3));

        // 1
        TreeNode root4 = new TreeNode();
        root4.val = 1;
        System.out.println("\n");
        print(test.printFromTopToBottom(root4));

        // null
        System.out.println("\n");
        print(test.printFromTopToBottom(null));
    }
