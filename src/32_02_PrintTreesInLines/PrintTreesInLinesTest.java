 ...
 * @description
 */
public class PrintTreesInLinesTest
{
    public static void main(String[] args)
    {
        ...
        System.out.println("\n");
        test.printTreesInLines(root3);

        // 1
        TreeNode root4 = new TreeNode();
        root4.val = 1;
        System.out.println("\n");
        test.printTreesInLines(root4);

        // null
        System.out.println("\n");
        test.printTreesInLines(null);
    }
}
